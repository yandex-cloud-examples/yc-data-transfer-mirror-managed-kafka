...
locals {
  ...
  # Set only after the source and target Managed Service for Apache Kafka® clusters are created.
  # Then run "terraform apply" to create Data Transfer endpoints and transfer.
